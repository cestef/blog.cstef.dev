...
date: 2023/09/24
description: How I solved the puzzle given by Traefik for their job application form
tag: [traefik, docker, kubernetes, ctf]
author: cstef
---
...
When looking for an alternative to [NGINX](https://www.nginx.com/),
...
By digging a little more on their website, I found a the [developer job application form](https://traefik.io/careers/developers-systems-engineers).
...
[
	{
		"Id": "sha256:8fd1aa093b13d1ebad4b58ab318f25e9f7d757a6cbc7391acc99518a81b5c144",
		"RepoTags": ["traefik/jobs:latest"],
		"RepoDigests": [
			"traefik/jobs@sha256:4e5b3dc8dbdf40b89969dbccbce84809a649b056e9793a9fc1a7613f13fe46fb"
		],
		"Parent": "",
		...
		"GraphDriver": {
			"Data": {
				"MergedDir": "/var/lib/docker/overlay2/f3a1840d370c70a6902af6316e9ab206bea745d9f773595e6b19e8e796df9eb8/merged",
				"UpperDir": "/var/lib/docker/overlay2/f3a1840d370c70a6902af6316e9ab206bea745d9f773595e6b19e8e796df9eb8/diff",
				"WorkDir": "/var/lib/docker/overlay2/f3a1840d370c70a6902af6316e9ab206bea745d9f773595e6b19e8e796df9eb8/work"
			},
			"Name": "overlay2"
		},
		"RootFS": {
			"Type": "layers",
			"Layers": ["sha256:852b54c4c0be1f879a3a868bb89119a68fa8a5155cec5d8e37cadba9ac38befb"]
		},
		"Metadata": {
...
> But remember, it's a secret <Twemoji emoji="🤫" />
...
I hope you enjoyed reading this article as much as I enjoyed writing it <Twemoji emoji="😄" />.
...
My aim was to allow you to learn something new, not to give you the solution on a silver platter <Twemoji emoji="😉" />.

All the manifests used in this article are available on [GitHub](https://github.com/cestef/blog.cstef.dev/tree/main/resources/traefik-jobs).
